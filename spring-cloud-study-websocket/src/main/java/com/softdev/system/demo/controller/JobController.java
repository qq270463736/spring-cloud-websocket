...
import com.softdev.system.demo.Quartz.BaseJob;
import org.quartz.*;
...
public class JobController
{
    ...
    {
        addJob(paraMap.get("jobClassName"), paraMap.get("jobGroupName"), paraMap.get("cronExpression"),"123");
    }

    public void addJob(String jobClassName, String jobGroupName, String cronExpression,String ylbh)throws Exception{
